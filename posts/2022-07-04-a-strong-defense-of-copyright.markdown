...
Well they're *not* paying for the content, they're paying for different
...
[^4]: Short for [Chunithm](https://rhythm-cons.wiki/w/Chunithm), an arcade
...
too), and then NEW came out 5 minutes from you, would you *really* ditch your
...
I'd actually argue in favor of the chart *videos* generally, I feel like
...
I would think so too, but apparently like board game rules aren't. Rules *text*
...
[^5]: A rhythm game played with a lifelike electric drumset controller, where
...
So *is* Konami the one that has the copyright there? Is it different if we
