...
Because I was seeing *something*, I could rule out the same things as with the
...
I first fired up Wireshark to confirm that, indeed, packets *were* actually
...
[^1]: The SDP also contains negotiation for media codecs, codec extensions,
