...
> the language), the harder it is to *understand* systems constructed in it.
...
<figure class="block-image"><img style="width: 100%" src="/uploads/unreadable-fp-mess.png" alt="A very strange implementation of BFS"/></figure>
