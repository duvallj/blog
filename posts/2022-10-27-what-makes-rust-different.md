...
This is the ***biggest*** thing ever. Like the other stuff I mention later on
is really important too, but without this *you don't have Rust*, you have
...
must guarantee that there are *no outstanding references to that variable*.
